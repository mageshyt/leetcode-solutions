...
const twoSum = (numbers, target) => {
  ...
  while (left < right) {
    const left_right_sum = numbers[left] + numbers[right];
    ...
    //! if our target is less than the sum of the left and right numbers, we need to move the right pointer to the left
    else if (left_right_sum > target) {
      right--;
    }
  }
