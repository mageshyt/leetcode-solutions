...
class MyCalendar {
  ...
  book(start, end) {
    for (let i = 0; i < this.booking.length; i++) {
      const [start_day, end_day] = this.booking[i];
      if (start < end_day && end > start_day) return false;
    }
...
const sol = new MyCalendar();

console.log(sol.book(10, 20));
console.log(sol.book(15, 25));
console.log(sol.book(20, 30));
