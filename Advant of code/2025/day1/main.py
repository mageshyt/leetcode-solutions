...
"""
# ===================== PART 1 =====================
def totalRotation(arr):
    n = len(arr)
    total_rotation = 0 # total rotation to zero
    """
     - starting point is 50
     - max number is 99
     - min number is 0
     - Left = (current - distance + 100) % 100
...
def totalRotationWithIntermediateZeros(arr):
    n = len(arr)
    total_rotation = 0 # total rotation to zero
    """
     - starting point is 50
...
with open("input.txt", "r") as file:
    ...
    print(input_data)
    print(totalRotation(input_data))

    print(totalRotationWithIntermediateZeros(input_data))
